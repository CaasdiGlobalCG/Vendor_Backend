...
const COPILOT_KNOWLEDGE_TABLE = 'copilot_knowledge'; // Copilot FAQ knowledge base
const COPILOT_CONVERSATIONS_TABLE = 'copilot_conversations'; // Copilot conversation history
...
export { dynamoDB, s3, kms, VENDORS_TABLE, GOOGLE_USERS_TABLE, LEADS_TABLE, PROJECTS_TABLE, PM_PROJECTS_TABLE, USERS_TABLE, WORKSPACES_TABLE, ACTIVITIES_TABLE, WORKSPACE_MESSAGES_TABLE, POST_SERVICES_TABLE, POST_SERVICES_NOTIFICATIONS_TABLE, COPILOT_KNOWLEDGE_TABLE, COPILOT_CONVERSATIONS_TABLE, S3_BUCKET_NAME, MESSAGE_UPLOADS_BUCKET, WORKSPACE_UPLOADS_BUCKET, KMS_KEY_ID };